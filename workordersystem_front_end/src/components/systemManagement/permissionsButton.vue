  ...
  <div class="permissionsButton">
    ...
    <div class="dataList">
      <div class="dataList_top">
        ...
        <p class="layui-btn-container">
          <router-link
            ...
            tag="button"
            type="button"
            v-if="this.$store.state.userId == 'admin' ? true : add"
          >
      ...
      <div class="dataList_table">
        <table id="permissionsButton" lay-filter="permissionsButton" lay-data="{id: 'serachData}"></table>
...
export default {
  ...
  mounted() {
    ...
    layui.use(["table", "form"], function() {
      ...
      //第一个实例
      table.render({
        elem: "#permissionsButton",
        url: "/api/getBtnList", //数据接口
        method: "post",
        id: "serachData",
