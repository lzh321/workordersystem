      ...
      table.render({
        ...
        cols: [
          [
            ...
            { field: "menuNo", title: "菜单编号", width:200, sort: false,align: "center"},
            { field: "menuPno", title: "菜单类型", width:260, sort: false,align: "center",templet: function(d){return d.menuPno == 1 ? '父级菜单' : '子级菜单'}},
