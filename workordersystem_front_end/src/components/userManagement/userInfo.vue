    ...
    <form class="layui-form layui-form-pane" action>
      ...
      <div class="basicInfo">
        ...
        <!-- <div class="layui-form-item">
          ...
          <div class="layui-form-mid layui-word-aux">请输入6位数密码</div>
        </div> -->
      ...
      <div class="layui-form-item">
        <div class="layui-input-block">
          <button class="layui-btn" lay-submit lay-filter="alterUser" v-show="show">立即修改</button>
  ...
  mounted() {
    ...
    layui.use(["form", "laydate"], function() {
      ...
      form.on("submit(alterUser)", function(data) {
        ...
        console.log(data.field)
        _this.$axios.post("/api/alterInfo", data.field).then(res => {
            console.log(res);
